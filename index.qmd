...
![Original image before stippling](index_files/figure-html/load-image-1.png){fig-cap="Original image before stippling"}
...
![Comparison of original image, importance map, and blue noise stippling](index_files/figure-html/display-results-1.png){fig-cap="Comparison of original image, importance map, and blue noise stippling"}
...
![Grid showing average tone in each section](index_files/figure-html/tone-analysis-1.png){fig-cap="Grid showing average tone in each section"}
...
![Side-by-side comparison of original and stippled images](index_files/figure-html/challenge-comparison-1.png){fig-cap="Side-by-side comparison of original and stippled images"}
